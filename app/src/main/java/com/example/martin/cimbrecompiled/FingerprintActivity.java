...
public class FingerprintActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mParaLabel = (TextView) findViewById(R.id.lblPara);
        mButton = (Button) findViewById(R.id.btnFP);
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), SuccessfulSetup.class);
            ...
            if(!fingerprintManager.isHardwareDetected()){
                ...
                if (cipherInit()){
                    ...
                    if (FingerprintHandler.isAuthenticated()){
                        Log.d("authen" , "yes authenticated");
                        //success();
                        Intent intent = new Intent(this, SuccessfulSetup.class);
                        intent.putExtra("username",strUsername);
                        startActivity(intent);
